...
export const servicesData = [
  {
    ...
    shortDesc: 'Safe, radiation-free pelvic ultrasound for diagnosis of bleeding, pain, cysts, and fertility concerns.',
...
Our aim is to help you remain healthy, active, and confident, while improving your quality of life during the menopausal transition and beyond.`,
  ...
  },
  {
    ...
    shortDesc: 'Evidence-based review of your diagnosis or advised treatment to help you make confident and informed healthcare decisions.',
    fullDesc: `When you are uncertain about a diagnosis, advised surgery, or not improving with treatment, seeking a second opinion can help you move forward with confidence. We provide a careful, comprehensive review of your medical history, examination findings, investigations, and previous treatment. The aim is to review the diagnosis, explore appropriate alternatives where available, and help you make informed decisions based on the best available evidence.`, 
