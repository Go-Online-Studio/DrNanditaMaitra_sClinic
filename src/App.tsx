...
import GynWellness from './components/GynWellness';
...
import { ArrowUp, ShieldAlert, Phone } from 'lucide-react';
  ...
  return (
    <Router basename="/">
      ...
      <div className="relative flex min-h-screen flex-col bg-[#FAF9F9] text-slate-800 font-sans selection:bg-[#d19890]/70 selection:text-[#4e2627] overflow-x-hidden" id="clinical-root">
        {/* Dynamic Ambient Glowing Orbs for Glassmorphism Background */}
        ...
        <div className="relative z-10 flex min-h-screen flex-col">
          {/* Upper Announcement Emergency Triage Bar */}
          {/* <div className="hidden sm:flex bg-[#4e2627]/95 backdrop-blur-sm text-[#F9F8F8] py-2 px-4 text-center text-xs font-medium border-b border-[#d19890]/30 font-sans items-center justify-center gap-2" id="announcement-bar">
            <ShieldAlert className="shrink-0 h-4 w-4 text-[#d19890] animate-pulse" />
            <span>For clinical emergencies in Vadodara, call directly: </span>
            <a href="tel:+912652331818" className="font-mono font-bold underline text-[#d19890] hover:text-[#F9F8F8] transition-colors">
              0265-2331818
            </a>
          </div> */}
          ...
          <main className="flex-grow" id="primary-content-wrapper">
            <Routes>
              ...
              <Route path="/gynecology" element={<GynWellness />} />
              <Route path="/earlypregnancycare" element={<Obstetrics />} />
          ...
          {/* Comprehensive Footer with maps, disclaimers, links */}
          <Footer />
        </div>
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3" id="floating-widgets">
          ...
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-75" style={{ animationDuration: '2s' }}></div>
            <a
              href={getWhatsAppUrl()}
              target="_blank"
