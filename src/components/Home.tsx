...
import { QuickInquiry, Testimonial } from '../types';
import { 
  Phone, 
  Award, 
  Stethoscope, 
...
export default function Home() {
  ...
  const handleFormSubmit = async (e: FormEvent) => {
    ...
    // Prepare WhatsApp message with attractive emojis and clean structure
    const formattedMessage =
`🌸 *Clinic Inquiry - Dr. Maitra's Clinic* 🌸
━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━
✨ Kindly confirm my clinic inquiry at your earliest convenience.
Thank you! 🙏`;
              ...
              <div className="relative z-20 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-2xl space-y-4 sm:space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-3">
                    ...
                    <button
                      type="button"
                      onClick={() => openWhatsAppModal({ reason: 'Infertility / Conception Issues' })}
                      className="rounded-full bg-emerald-600 hover:bg-emerald-700 px-8 py-3.5 text-xs font-bold uppercase tracking-wider text-white shadow-md transition-all hover:scale-102 flex items-center justify-center gap-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-400"
                      id="home-hero-whatsapp-btn"
                    >
                      <svg viewBox="0 0 24 24" fill="currentColor" className="shrink-0 h-4 w-4">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center space-y-5 border-b border-[#d19890]/15 pb-8 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-10">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                For appointment confirmations, or direct driving landmarks to our Race Course office, use the links below.
              </p>
