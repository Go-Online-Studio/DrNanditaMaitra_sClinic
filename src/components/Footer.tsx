    ...
    <footer className="bg-[#4e2627] text-[#F9F8F8] border-t-4 border-[#d19890]" id="app-footer">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          ...
          <div className="flex-1 max-w-md md:max-w-[258px] space-y-5 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="space-y-4 font-sans flex flex-col items-center md:items-start w-full">
              ...
              <button
                ...
                className="group flex flex-col items-center md:flex-row md:items-start gap-3 text-center md:text-left hover:text-[#d19890] transition-colors cursor-pointer focus:outline-none focus:underline"
                aria-label="Open WhatsApp Inquiry Form"
                id="footer-whatsapp-btn"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="shrink-0 h-5 w-5 text-[#d19890] group-hover:scale-110 transition-transform">
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-xs text-[#F9F8F8]/65 sm:flex-row font-sans">
          <p className='text-center sm:text-left'>© {currentYear} All rights reserved by Panchshil Gynecology Clinic. Designed and developed by <a className="hover:text-[#ffffff] transition-colors focus:outline-none" href="https://shriiitrackingsolution.in/" target="_blank" rel="noopener noreferrer"> <b>Shriii&nbsp;Tracking&nbsp;Solution</b>
          </a> </p>
