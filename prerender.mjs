...
const pageMeta = {
  about: {
    title:
      "About Dr. Nandita Maitra | MBBS MD FRCOG Senior Gynecologist Vadodara",
    description:
  ...
  "patient-education": {
    title:
      "Patient Education – Women's Health Articles | Dr. Nandita Maitra Vadodara",
    description:
  ...
  "patient-education/understanding-pcos": {
    title:
      "Understanding PCOS: Symptoms, Diagnosis & Management | Dr. Nandita Maitra Vadodara",
    description:
    ...
    canonical:
      "https://www.drnanditamaitra.com/patient-education/understanding-pcos",
  },
  "patient-education/cervical-screening-pap-smear": {
    ...
    canonical:
      "https://www.drnanditamaitra.com/patient-education/cervical-screening-pap-smear",
  },
  "patient-education/navigating-menopause": {
    title:
      "Navigating Menopause: Evidence-Based Symptom Relief | Dr. Nandita Maitra Vadodara",
    description:
    ...
    canonical:
      "https://www.drnanditamaitra.com/patient-education/navigating-menopause",
  },
  "patient-education/early-pregnancy-care-first-trimester": {
    title:
      "Early Pregnancy Care – First Trimester Guide | Dr. Nandita Maitra Vadodara",
    description:
    ...
    canonical:
      "https://www.drnanditamaitra.com/patient-education/early-pregnancy-care-first-trimester",
  },
  "patient-education/fertility-evaluation-when-to-consult": {
    title:
      "Fertility Evaluation: When to Consult a Gynecologist | Dr. Nandita Maitra Vadodara",
    description:
    ...
    canonical:
      "https://www.drnanditamaitra.com/patient-education/fertility-evaluation-when-to-consult",
  },
  "services/cervical-screening": {
    title: "Cervical Screening & Colposcopy | Dr. Nandita Maitra Vadodara",
    description:
      "Comprehensive evaluation for cervical and vulval health including HPV testing and colposcopy.",
  ...
  "services/colposcopy-and-vulval-evaluation": {
    ...
    canonical:
      "https://www.drnanditamaitra.com/services/colposcopy-and-vulval-evaluation",
  },
  "services/gynecologic-ultrasound": {
    ...
    canonical:
      "https://www.drnanditamaitra.com/services/gynecologic-ultrasound",
  },
  "services/fertility-consultation": {
    ...
    canonical:
      "https://www.drnanditamaitra.com/services/fertility-consultation",
  },
  "services/pcos-care": {
  ...
  "services/menopause-consultation": {
    ...
    canonical:
      "https://www.drnanditamaitra.com/services/menopause-consultation",
  },
  "services/pregnancy-consultation": {
    title:
      "Pregnancy Consultation & Antenatal Care | Dr. Nandita Maitra Vadodara",
    description:
      "Expert consultation for early pregnancy concerns, antenatal guidance, and high-risk care.",
    canonical:
      "https://www.drnanditamaitra.com/services/pregnancy-consultation",
  },
  "services/second-opinion": {
